...
export const colorRules = [v => !!v || "Color is required"];
...
export const roleRules = [v => !!v || "Role is required"];
...
export const projectTypeRules = [v => !!v || "Project type is required"];

// Rules for Document.
export const fileFormatRules = [v => !!v || "File format is required"];

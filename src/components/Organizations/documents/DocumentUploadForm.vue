    ...
    <template #content>
      <v-form ref="form" v-model="valid">
        <v-alert
          ...
          dismissible
        >
          The file could not be uploaded. Maybe invalid format. Please check
        ...
        <code v-if="selectedFormat" class="mb-10 pa-5 highlight">
          <span
            v-for="(example, index) in selectedFormat.examples"
            :key="index"
            >{{ example }}</span
          >
        </code>
